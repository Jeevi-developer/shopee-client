    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-purple-600 to-pink-600 text-white py-2 px-4 text-center text-sm">
        <p className="font-medium">
          🎉 Special Offer: Get 50% OFF on all categories! Limited time only
        </p>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="flex items-center justify-end space-x-4 p-2 bg-white shadow-sm">
              ...
              <Link
                to="/Login"
                className="text-gray-700 hover:text-indigo-600 font-m
        edium transition-colors"
              >
                login
              </Link>
              {/* Start a Seller */}
        ...
        {selectedCategory && selectedSubcategory ? (
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-8">
              Browse our amazing collection of{" "}
