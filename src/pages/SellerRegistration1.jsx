...
const SellerRegistration = () => {
  ...
  const addArrayField = (field, newObj) => {
    setFormData((prev) => ({
      ...prev,
  ...
  const handleAgreementUpload = (e) => {
    ...
    if (file.size > 10 * 1024 * 1024) {
      setErrors((prev) => ({
        ...prev,
        signedAgreement: "File must be less than 10MB",
      }));
      return;
    }
    ...
    // remove previous error once valid
    setErrors((prev) => ({
      ...prev,
      signedAgreement: "",
    }));
    ...
    switch (step) {
      case 1: // Personal Information
        ...
        if (!formData.signedAgreement) {
          errors.signedAgreement = "Signed agreement is required";
        }
...
=========================== */}
            <div className="mt-4">
              ...
              <p className="text-sm text-red-600 mt-1 font-medium">
                ⚠️ Must read and upload the agreement. Registration will not
                proceed without it.
              </p>
            </div>
          </div>
